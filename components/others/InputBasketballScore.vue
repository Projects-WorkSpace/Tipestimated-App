...
import basketballResults from '~/constants/basketballResults';
import { IOverUnder } from '~/types/plays';
...
const possibleScores = computed(() => basketballResults.sort((a, b) => a.id - b.id));
