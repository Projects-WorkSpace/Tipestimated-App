  ...
  <UModal :model-value="isOpen" @update:model-value="toggleModal" :overlay="true" :ui="{
    ...
    <div class="w-full flex flex-col px-5 py-4 gap-y-4">
        ...
        <div class="w-full flex items-center justify-between">
          <div class="flex items-center">
            <div class="flex items-center mr-4">
              <UCheckbox :checked="selected_all" :model-value="selected_all" :ui="checkBoxUi"
                @click="selectAllGroups(!selected_all)" />
            </div>
            <div class="">
      ...
      <div class="w-full flex flex-col py-1">
        <ul v-if="groups.length > 0" class="w-full flex flex-col gap-y-2">
          <li v-for="group in groups" :key="group.id" class="w-full flex items-center">
            <div role="button" class="flex items-center flex-none mr-4"
              ...
              <UCheckbox :checked="group.checked" :ui="checkBoxUi" v-model="group.checked" />
            </div>
        ...
        <div v-else class="w-full flex flex-col items-center justify-center">
          <div class="mb-3">
            <Icon name="mdi:account-multiple" class="w-14 h-14 text-neutral-600" />
          </div>
          <p class="text-xl">Empty groups</p>
          <div class="mt-2.5">
