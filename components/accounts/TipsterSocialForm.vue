  ...
  <div class="w-full flex flex-col">
    <div class="w-full flex flex-col gap-y-5 pb-6">
      <div class="w-full flex flex-col">
        ...
        <p
          v-if="error_status.telegram"
          class="w-full text-xs text-red-500 mt-1.5 ml-0.5"
        >
      ...
      <div class="w-full flex flex-col">
        ...
        <p
          v-if="error_status.social_link"
          class="w-full text-xs text-red-500 mt-1.5 ml-0.5"
        >
          Enter valid {{ social_name.name }} link
        </p>
      </div>
      <div class="w-full">
        <ContainersListboxComponent
          ...
          :error_status="error_status.experience"
          error_text="Select your years of experience"
        />
      </div>
        ...
        <div class="relative bg-inherit w-full flex items-center gap-x-1">
          <div class="flex-none">
            ...
            >
              <NuxtImg
                v-if="hasImage"
                :src="image_file.imageURL || defaultImage"
                alt="Uploaded Image"
          ...
          <div class="relative grow">
            ...
            >
              ...
              >
                ...
                <p v-else class="text-sm">Upload profile photo</p>
              </label>
            </button>
          </div>
        </div>
        <p
          v-if="error_status.profile"
          class="w-full text-xs text-red-500 mt-1.5 ml-0.5"
        >
          Upload an image
        </p>
