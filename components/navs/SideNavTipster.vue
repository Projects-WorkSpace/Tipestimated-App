...
<template>
  <div
    class="w-full xl:min-w-[250px] h-full flex flex-col justify-between pt-8 pb-4"
  >
    ...
    <div class="w-full flex flex-col px-6 gap-y-4">
      <div v-if="isTipster" class="w-full flex flex-col">
        ...
        >
          ...
          >
            <Icon
              name="mdi:plus"
              class="text-neutral-700 text-xl md:text-2xl"
            />
          </span>
      ...
      <div class="w-full flex flex-col">
        ...
        >
          ...
          <span class="text-base font-medium hidden xl:block"
            >Tipster Rank</span
          >
        </NuxtLink>
