...
const getTipster = async () => {
    ...
    const { onResult, onError } = useQuery<ITipsterData>(GetTipster, { tipsterId: route.params.tipsterID });
    onResult((result) => {
                ...
                <Transition>
                    <div v-if="!loadingTipster" class="w-full">
                        <div v-if="tipster" class="w-full">
                            <ContainersTipsterHeader :tipster="tipster" @update-follow-status="updateFollowStatus" />
                        </div>
                    </div>
